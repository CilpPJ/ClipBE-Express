...
## 커밋 메세지 작성 규칙
- 커밋메세지는 파일 하나씩 그 파일에 대한 작업에 대해 작성합니다.
- 커밋메세지는 간결하게 작성합니다.
- 커밋메세지는 변경된 파일이 많다면, 주요 변경 사항을 요약합니다.
- 커밋메세지는 다음과 같은 형식을 따릅니다:
  - feat: 새로운 기능 추가
  - fix: 버그 수정
  - docs: 문서 수정
  - style: 코드 포맷팅, 세미콜론 누락, 코드 변경 없음
  - refactor: 코드 리팩토링
  - test: 테스트 코드 추가, 리팩토링 테스트 코드 변경 없음
  - chore: 빌드 업무 수정, 패키지 매니저 설정 변경 등
- 커밋메세지는 한글로 작성합니다.
- 커밋메세지는 명령문으로 작성합니다.
